...
export const builtInUnits = makeUnits(
    {
        ...
        /** Newtons */
        "N": { s: 1e+0, d: new Dimensions([1, 1, -2, 0, 0, 0, 0, 0]) },
        ...
        /** Watts */
        "W": { s: 1e+0, d: new Dimensions([1, 2, -3, 0, 0, 0, 0, 0]) },
        /** Metric horsepower */
        // "PS": { s: 7.3549875e+2, d: new Dimensions([1, 2, -3, 0, 0, 0, 0, 0]) },
        /** Mechanical Horsepower - Defined as 33 000 ft lbf / min */
        "HP": { s: 7.4569987158227e+2, d: new Dimensions([1, 2, -3, 0, 0, 0, 0, 0]) },
        ...
        /** Litres */
        "L": { s: 1e-3, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "tsp": { s: 4.92892159375e-6, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "tspm": { s: 5e-6, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "tbs": { s: 1.478676478125e-5, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "fl_oz": { s: 2.95735295625e-5, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "uk_fl_oz": { s: 2.84130625e-5, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "cup": { s: 2.365882365e-4, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "pt": { s: 4.73176473e-4, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "uk_pt": { s: 5.6826125e-4, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "qt": { s: 9.46352946e-4, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "uk_qt": { s: 1.1365225e-3, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "gal": { s: 3.785411784e-3, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "uk_gal": { s: 4.54609e-3, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "bushel": { s: 3.523907016688e-2, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "bbl": { s: 1.58987294928e-1, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "oilbarrel": { s: 1.58987294928e-1, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "beerbarrel": { s: 1.17347765304e-1, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "uk_beerbarrel": { s: 1.6365924e-1, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "MTON": { s: 1.13267386368e+0, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "GRT": { s: 2.8316846592e+0, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "gill": { s: 1.1829411825e-4, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "uk_gill": { s: 1.420653125e-4, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "peck": { s: 8.80976754172e-3, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "dry_gal": { s: 4.40488377086e-3, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "dry_qt": { s: 1.101220942715e-3, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "dry_pt": { s: 5.506104713575e-4, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        // "stere": { s: 1e+0, d: new Dimensions([0, 3, 0, 0, 0, 0, 0, 0]) },
        ...
        // "A": { s: 1e+0, d: new Dimensions([0, 0, 0, 0, 1, 0, 0, 0]) },
